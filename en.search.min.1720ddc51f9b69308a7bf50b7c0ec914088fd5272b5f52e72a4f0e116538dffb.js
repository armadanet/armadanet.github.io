...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.62df342abfa469ac208fd47d4d4e75399cc19960cb393ea9bb45d8507eb1dfe1.js',function(){input.required=false;search();});}
